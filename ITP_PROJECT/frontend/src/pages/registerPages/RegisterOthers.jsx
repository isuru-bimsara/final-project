// //frontend/src/pages/RegisterOthers.jsx
...
// import { OTHER_ROLE_OPTIONS } from "../../components/utils/roleOption";
// import Navbar from "../components/routes/Navbar";
// import Footer from "../components/routes/Footer";

// const API_URL = "http://localhost:5000/api/user/register";

// export default function RegisterOthers() {
//   return <RegisterOthersLayout />;
// }

// function RegisterOthersLayout() {
...
//   // const showCompanyName = form.role === "supplier";

//   const handleRoleChange = (e) => {
//     const selected = e.target.value;
//     const roleObj = OTHER_ROLE_OPTIONS.find((r) => r.value === selected);
//     setForm((prev) => ({
//       ...prev,
//       role: selected,
//       departmentName: roleObj?.department || "",
//     }));
//   };
...
//     setForm((prev) => ({
//       ...prev,
//       contactNumber: sanitizeContact(e.target.value),
//     }));
...
//       return;
//     }
//     if (showDepartmentName && !form.departmentName) {
//       setError("Department name missing for this role.");
//       return;
//     }
...
//             Choose your management role and gain access to the modules that fit
...
//               {/* Role & dynamic fields */}
//               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                 <Field label="Role" required icon={<FiBriefcase />}>
//                   <select
//                     name="role"
//                     value={form.role}
...
//                   required
//                 />
//                 <label htmlFor="agree-others" className="text-sm text-gray-600">
//                   I agree to the{" "}
//                   <Link
//                     to="/terms"
...
function RegisterOthersLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* ✅ MAIN CONTENT - Takes available space, allows scrolling */}
