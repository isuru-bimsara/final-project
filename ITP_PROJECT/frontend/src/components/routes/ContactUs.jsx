...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section (no images; pure SVG pattern) */}
      <motion.section 
            ...
            {[
              {
                ...
                title: "Visit Us",
                info: ["123 Garment Street", "Colombo 10", "Sri Lanka"]
              },
              {
                icon: <FiPhone className="text-blue-600" size={24} />,
                title: "Call Us",
                info: ["+94 123 456 789", "+94 987 654 321"]
              },
              {
                icon: <FiMail className="text-blue-600" size={24} />,
                title: "Email Us",
                info: ["info@garmentfactory.com", "sales@garmentfactory.com"]
              }
            ].map((contact, index) => (
              <motion.div
                key={index}
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            >
              ...
              <div className="rounded-lg overflow-hidden shadow-lg h-96">
                {/* Google Maps embed (no images used) */}
                <iframe 
                ...
                <details className="group">
                  <summary className="flex justify-between items-center font-medium cursor-pointer list-none p-6">
                    ...
                    <span className="transition group-open:rotate-180">
                      <svg fill="none" height="24" strokeWidth="1.5" viewBox="0 0 24 24" width="24" stroke="currentColor" aria-hidden="true">
